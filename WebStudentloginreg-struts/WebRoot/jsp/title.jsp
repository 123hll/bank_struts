...
<head>
    ...
    <script language="javascript">
        function adminDel(userId)
        {
            if(confirm('您确定删除吗？'))
            {
                window.location.href="student.do?command=TitleDel&userId="+userId;
            }
        }
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
    ...
    <c:forEach items="${title}" var="s">
        <tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td bgcolor="#FFFFFF" align="center">
                <a href="student.do?command=UpdateTitle&id=${s.id}">${s.head}</a>
            </td>
            <td bgcolor="#FFFFFF" align="center">
                    ${s.time}
            </td>
            <td bgcolor="#FFFFFF" align="center">
                ...
                <a href="student.do?command=UpdateTitle&id=${s.id}">修改</a>
            </td>
        </tr>
    </c:forEach>
</table>
