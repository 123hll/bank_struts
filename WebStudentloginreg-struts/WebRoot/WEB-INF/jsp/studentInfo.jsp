...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!-- 	<link rel="stylesheet" type="text/css" href="<%=path %>/css/base.css" />	 -->
        ...
        <script language="javascript">
           function adminDel(userId)
           {
               if(confirm('您确定删除吗？'))
               {
                  window.location.href="student.do?command=delUserById&userId="+userId;
               }
           }

           function adminAdd()
           {
                 var url="<%=path %>/jsp/adduser.jsp";
	...
	<body leftmargin="2" topmargin="2" >
			<table>
			<form action="studentInfo.do?command=findUserByName" name="formUpdata" method="post">
				<tr >
				用户查询
				</tr>
				<tr>
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						 ...
						 <a href="student.do?id=${s.id}&command=updataUser">修改</a>
					</td>
				</tr>
				</c:forEach>
			</table>
